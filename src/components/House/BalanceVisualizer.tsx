              ...
              <Box key={humour} sx={{ flex: '1 1 45%', minWidth: '150px' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <Typography variant="body2" sx={{ fontWeight: 'bold', fontSize: '0.875rem' }}>
                    <NumberWithFraction value={baseScore[humour]} />
                  </Typography>
                </Box>
              </Box>
            );
            ...
            return (
              <Box key={humour} sx={{ flex: '1 1 45%', minWidth: '150px' }}>
                <Box sx={{ 
                  ...
                  <Typography variant="body2" sx={{ fontWeight: 'bold', fontSize: '0.875rem', color: isStrength ? 'green' : isWeakness ? 'red' : 'inherit' }}>
                    <NumberWithFraction value={currentModifiedScore[humour]} />
                    {isStrength && ' ↑'}
                    {isWeakness && ' ↓'}
                  </Typography>
                </Box>
              ...
              return (
                <Box key={humour} sx={{ flex: '1 1 45%', minWidth: '150px' }}>
                  <Box sx={{ 
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 'bold', fontSize: '0.875rem', color: isStrength ? 'green' : isWeakness ? 'red' : 'inherit' }}>
                      <NumberWithFraction value={previewModifiedScore[humour]} />
                      {isStrength && ' ↑'}
                      {isWeakness && ' ↓'}
                    </Typography>
                  </Box>
